app.factory('parseService', ['$rootScope', function ($rootScope) {
    ...
    return {
        ...
        createFollow: function (followObj) {
            var Follow = Parse.Object.extend("Follow");
            var follow = new Follow();
            return follow.save(followObj);
        },
        getAllFollows: function (currentProfileUserObj) {
            var Follow = Parse.Object.extend("Follow");
            var query = new Parse.Query("Follow");
            query.equalTo("follower", currentProfileUserObj);
            return query.find();
        },
        doesCurrentUserFollow: function (currentProfileUserObj) {
            var Follow = Parse.Object.extend("Follow");
            var query = new Parse.Query("Follow");
            query.equalTo("followee", currentProfileUserObj);
            query.equalTo("follower", $rootScope.loggedInUser);
            return query.find();
        },
